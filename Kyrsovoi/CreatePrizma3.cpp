// CreatePrizma3.cpp: файл реализации
//
...
// диалоговое окно CCreatePrizma3

IMPLEMENT_DYNAMIC(CCreatePrizma3, CDialogEx)

CCreatePrizma3::CCreatePrizma3(CWnd* pParent /*=NULL*/)
	: CDialogEx(CCreatePrizma3::IDD, pParent)
{

}

CCreatePrizma3::~CCreatePrizma3()
{
}

void CCreatePrizma3::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CCreatePrizma3, CDialogEx)
	ON_BN_CLICKED(IDOK, &CCreatePrizma3::OnBnClickedOk)
	ON_BN_CLICKED(IDCANCEL, &CCreatePrizma3::OnBnClickedCancel)
END_MESSAGE_MAP()
// обработчики сообщений CCreatePrizma3
void CCreatePrizma3::Set_first(dra* first)
{
	f=first;
}
void CCreatePrizma3::Get_Numb(int N)
{
	Number=N;
}

BOOL CCreatePrizma3::OnInitDialog()
{
...
void CCreatePrizma3::OnBnClickedOk()
{
CString S;
...
void CCreatePrizma3::OnBnClickedCancel()
{
	Ex=0;
	CDialogEx::OnCancel();
}
