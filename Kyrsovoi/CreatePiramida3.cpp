// CreatePiramida3.cpp: файл реализации
//
...
IMPLEMENT_DYNAMIC(CCreatePiramida3, CDialogEx)

CCreatePiramida3::CCreatePiramida3(CWnd* pParent /*=NULL*/)
	: CDialogEx(CCreatePiramida3::IDD, pParent)
{

}

CCreatePiramida3::~CCreatePiramida3()
{
}

void CCreatePiramida3::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CCreatePiramida3, CDialogEx)
	ON_BN_CLICKED(IDOK, &CCreatePiramida3::OnBnClickedOk)
	ON_BN_CLICKED(IDCANCEL, &CCreatePiramida3::OnBnClickedCancel)
END_MESSAGE_MAP()


// обработчики сообщений CCreatePiramida3
void CCreatePiramida3::Set_first(dra* first)
{
	f=first;
}


void CCreatePiramida3::Get_Numb(int N)
{
	Number=N;
}

BOOL CCreatePiramida3::OnInitDialog()
{
...
void CCreatePiramida3::OnBnClickedOk()
{
	CString S;
...
void CCreatePiramida3::OnBnClickedCancel()
{
	Ex=0;
	CDialogEx::OnCancel();
}
