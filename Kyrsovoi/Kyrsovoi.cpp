...
// Kyrsovoi.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKyrsovoiApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CKyrsovoiApp::OnAppAbout)
	// Стандартные команды по работе с файлами документов
	ON_COMMAND(ID_FILE_NEW, &CWinAppEx::OnFileNew)
	ON_COMMAND(ID_FILE_OPEN, &CWinAppEx::OnFileOpen)
	// Стандартная команда настройки печати
	ON_COMMAND(ID_FILE_PRINT_SETUP, &CWinAppEx::OnFilePrintSetup)
//	ON_COMMAND(ID_CHANGE, &CKyrsovoiApp::OnChange)
END_MESSAGE_MAP()


// создание CKyrsovoiApp

CKyrsovoiApp::CKyrsovoiApp()
{
	...
	SetAppID(_T("Kyrsovoi.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CKyrsovoiApp

CKyrsovoiApp theApp;


// инициализация CKyrsovoiApp

BOOL CKyrsovoiApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CKyrsovoiDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CKyrsovoiView));
	if (!pDocTemplate)
		return FALSE;
...
// обработчики сообщений CKyrsovoiApp
...
void CKyrsovoiApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CKyrsovoiApp настройка методов загрузки и сохранения

void CKyrsovoiApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CKyrsovoiApp::LoadCustomState()
{
}

void CKyrsovoiApp::SaveCustomState()
{
}

// обработчики сообщений CKyrsovoiApp

BOOL CKyrsovoiApp::OnIdle(LONG lCount)
{
	( (CKyrsovoiView*) ((CMainFrame*)m_pMainWnd)->GetActiveView() )->display();
